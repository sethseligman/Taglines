...
export function HowToPlayModal() {
  ...
  useEffect(() => {
    const handleOpenHtp = () => setOpen(true);
  ...
  return (
    <div
      className="pointer-events-auto fixed inset-0 z-[200] flex w-full flex-col items-center justify-center"
      style={{
      ...
      >
        <div className="px-5 pb-6 pt-5 md:px-6 md:pb-7 md:pt-6">
          <div className="flex items-start justify-between gap-3">
            <p className="leading-tight" style={{ fontFamily: PF, fontSize: 18, fontWeight: 700 }}>
            ...
            >
              <span className="relative block size-3" aria-hidden>
                <span className="absolute left-1/2 top-1/2 block h-px w-[11px] -translate-x-1/2 -translate-y-1/2 rotate-45 bg-muted" />
                <span className="absolute left-1/2 top-1/2 block h-px w-[11px] -translate-x-1/2 -translate-y-1/2 -rotate-45 bg-muted" />
              </span>
            </button>
          </div>
          <p className="mt-2 text-[13px] italic leading-snug" style={{ fontFamily: PF, color: "var(--gold)" }}>
            One movie. Every day.
          </p>
          ...
          <div className="mt-6">
            ...
            <StepBlock dividerColor={dividerColor} stepIndex={2}>
              ...
              <p
                className="mt-2"
                style={{ fontFamily: DM, fontSize: "0.85rem", color: "var(--muted)", lineHeight: 1.5 }}
              >
            ...
            <StepBlock dividerColor={dividerColor} stepIndex={3}>
              ...
              <ul className="mt-3 list-none space-y-2 p-0">
                <HintTileDim
                  text="The employer here makes Amazon look generous."
                  bg={dimTileBg}
